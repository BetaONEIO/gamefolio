        ...
        <div className="modal-container w-full sm:w-2/3 md:w-1/2 lg:w-1/4 mx-auto lg-rounded z-50 overflow-y-auto">
          ...
          <div className="relative p-4 rounded-lg bg-[#091619] sm:p-5 border border-[#586769]">
            ...
            >
              ...
              <button className="w-full font-bold h-[50] bg-gradient-to-b from-[#62C860] to-[#37C535] text-white text-center py-[10px] px-[30px] rounded-tl-[20px] rounded-br-[20px] rounded-tr-[5px] rounded-bl-[5px] mb-3">
                Save
              </button>
            </form>
          </div>
