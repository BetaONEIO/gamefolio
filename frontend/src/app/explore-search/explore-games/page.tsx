          ...
          {games.map((items, index) => (
            <div key={index} className="relative flex flex-col items-center">
              <Image
                ...
                height="133"
                sizes="100vw"
                className=" h-56 w-44 object-cover rounded-xl  focus:ring-primary-600 focus:border-primary-600 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400  dark:focus:ring-primary-500 dark:focus:border-primary-500"
              />
