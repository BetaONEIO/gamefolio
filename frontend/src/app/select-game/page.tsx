  ...
  return (
    <CustomBackground>
      <div className="flex flex-col items-center justify-center px-6 py-8 h-screen ">
        <div className="p-6 space-y-4 h-5/6  sm:p-8 md:w-96 bg-[#091619] rounded-xl border border-[#1C2C2E]">
          <div>
            <h2
              className={`${leagueGothic.className} text-center text-2xl sm:text-3xl`}
            >
              FAVORITES GAMES
            </h2>
          </div>
