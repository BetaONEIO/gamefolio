  ...
  return (
    <Layout>
      <Suspense>
        ...
        <div
          className="flex flex-col items-center lg:flex-row lg:justify-center gap-4 h-60 pl-8 m-4"
          style={{
          ...
          <div>
            ...
            <div className="flex justify-center items-center gap-8 mt-2">
              <Image
                ...
                height={40}
              />
              <Image src={IMAGES.Badges2} alt="Badge" width={40} height={40} />
              <Image src={IMAGES.Badges3} alt="Badge" width={40} height={40} />
              <Image src={IMAGES.Badges4} alt="Badge" width={40} height={40} />
              <Image src={IMAGES.Badges5} alt="Badge" width={40} height={40} />
            </div>
          </div>
          <div>
